...
var myData =[];
	...
	var lineUrlEncode = querystring.stringify({line: lines[lineNo]});
	console.log(lineUrlEncode);
	var url = "http://express.heartrails.com/api/json?method=getStations&" + lineUrlEncode;
	...
	request({url:url, json:true}, function (error, response, body) {
		console.log(body);
//		console.log(body.response.station);
//		foreach(var data in body.response.station)
//			myData.;
//			console.log(myData)
//		};
...
fs.writeFile("eki.json", myData, function(err) {
    if(err) {
      console.log(err);
    } else {
